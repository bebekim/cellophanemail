...
decisions using horsemen-based threat detection.
"""
...
class TestGraduatedDecisionIntegration:
    ...
    async def test_processor_uses_graduated_decision_maker(self):
        ...
        print(f"Clean email: action={result.protection_action}, threat_level={result.analysis.threat_level}")
    ...
    async def test_processor_handles_context_addition(self):
        ...
        print(f"Minor toxic: action={result.protection_action}, threat_level={result.analysis.threat_level}")
    ...
    async def test_processor_handles_redaction(self):
        ...
        print(f"Moderate toxic: action={result.protection_action}, threat_level={result.analysis.threat_level}")
    ...
    async def test_processor_handles_summary_only(self):
        ...
        print(f"High toxic: action={result.protection_action}, threat_level={result.analysis.threat_level}")
    ...
    async def test_processor_handles_block_entirely(self):
        ...
        print(f"Extreme toxic: action={result.protection_action}, threat_level={result.analysis.threat_level}")
    ...
    async def test_processor_backward_compatibility(self):
        ...
        print(f"Normal email: action={result.protection_action}, threat_level={result.analysis.threat_level}")
