...
class TestEmailCompositionStrategy:
    ...
    def test_compose_forward_clean_email(self):
        ...
        assert "X-Threat-Level" in composition.headers
    ...
    def test_compose_redacted_email(self):
        ...
        assert "threat level: medium" in composition.body
        ...
        assert composition.headers["X-Threat-Level"] == "medium"
    ...
    def test_transparency_headers_optional(self):
        ...
        assert "X-Threat-Level" not in composition.headers
