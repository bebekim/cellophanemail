...
class BasePlugin(ABC):
    ...
    async def process_email(self, email_message: EmailMessage) -> EmailMessage:
        """Process an email message through the plugin pipeline.
        
        This is a hook for plugins that need to modify or enrich
        email messages before they go through the Four Horsemen analysis.
        """
